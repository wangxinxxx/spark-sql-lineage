[![License](http://img.shields.io/:license-Apache_v2-blue.svg)](https://github.com/wangxinxxx/spark-sql-lineage/blob/master/LICENSE)
[![Build and test](https://github.com/wangxinxxx/spark-sql-lineage/workflows/Build%20and%20test/badge.svg)](https://github.com/wangxinxxx/spark-sql-lineage/actions?query=workflow%3A%22Build+and+test%22)
...
For more visualization examples, please see a [tpcds-flow-tests](https://github.com/wangxinxxx/spark-sql-lineage/tree/spark-3.2/src/test/resources/tpcds-flow-tests/results) folder
...
$ git clone https://github.com/wangxinxxx/spark-sql-lineage.git
$ cd spark-sql-lineage
 ...
 * Implements more graph exporters, e.g., for [Apache Atlas](https://atlas.apache.org/#/) and [DataHub](https://datahubproject.io/)/[Acryl Data](https://www.acryldata.io/) ([Issue#3](https://github.com/wangxinxxx/spark-sql-lineage/issues/3))
 * Tracks data lineage between table/views via `INSERT` queries ([Issue#5](https://github.com/wangxinxxx/spark-sql-lineage/issues/5))
...
If you hit some bugs and have requests, please leave some comments on [Issues](https://github.com/wangxinxxx/spark-sql-lineage/issues)
